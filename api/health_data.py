...
from app.schemas import health_data_schema
from app.crud import health_data_crud
...
def create_health_data(health_data: health_data_schema.HealthDataCreate, 
                       db: Session = Depends(get_db), 
                       current_user: int = Depends(get_current_user)):
    return health_data_crud.create_health_data(db=db, health_data=health_data, user_id=current_user.id)
